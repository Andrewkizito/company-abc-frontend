      ...
      <Grid container spacing={3} justifyContent="center">
        <Grid item xs={12} sm={6}>
          <TextInput
            ...
            inputProps={{
              ...
              onChange: (e: React.ChangeEvent<HTMLInputElement>) => { updateState('productName', e.target.value, setForm) }
            }}
          />
          <TextInput
            label={'Description'}
            inputProps={{
              ...
              onChange: (e: React.ChangeEvent<HTMLInputElement>) => { updateState('description', e.target.value, setForm) }
            }}
          />
          <TextInput
            label={'Product Units'}
        ...
        <Grid item xs={12} sm={6}>
          <ImageUploader
            label={'Product Photo'}
            value={form.image}
            setValue={(imageUrl: string) => { updateState('image', imageUrl, setForm) }
            }
            setImage={setImage}
          />
        </Grid>
        ...
        <Grid item xs={12} sm={6}>
          ...
          <Rating
            precision={0.5}
            value={form.rating}
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => { updateState('rating', parseInt(e.target.value), setForm) }
            }
          />
        </Grid>
        <Grid item xs={12} sm={6}>
